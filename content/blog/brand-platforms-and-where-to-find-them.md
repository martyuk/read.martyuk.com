...
### Сникерс
И мне, как человеку, который работал в BBDO, сложно не рассказать про Сникерс. Платформа "ты не ты, когда голоден" появилась постепенно. Все начало с того, что команда бренда хотела рассказать про большое количество орехов. Из этого родилась территория голода, как момента, когда вы плохо соображаете. Вот смотрите (и обратите внимание на "great googly moogly" — это пример отличного копирайта, который до сих пор живет в популярной культуре):
`youtube: D0IfvjoOqro`

Следующим шагом появилась формулировка "ты не ты" и прямая визуализация этого слогана.
`youtube: Zfg7XT_8Rto`

Эта хорошая платформа, потому что она решает большое количество задач. Например, вы можете использовать в ролике селебрити.
`youtube: iGsuZAUOMcA`

Или вы можете сделать на основе этой платформы большую диджитальную активацию с промо.
`youtube: bulCWD5yc2Q`

При желании вы всегда можете откатиться обратно, и перестать использовать прием с превращениями. И так _тоже работает_!
`youtube: 3OKj_jZmonM`
