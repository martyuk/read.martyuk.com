...
Я не буду в очередной раз утомлять вас Nike и платформой Just Do It. Расскажу что-нибудь интересненькое про GIECO и Bud Light.
...
### Сникерс
Мне, как человеку, который работал в BBDO сложно пройти мимо и не рассказать про Сникерс. Потому что у Сникерса одна из самых гениальных платформ, и вы ее точно знаете. Конечно же, я говорю про "ты не ты, когда голоден".

Но "ты не ты" появилась не сразу, а формулировалась постепенно. Все началось с запроса команды бренда рассказать про большое количество орехов. Из этого родилась территория голода, как момента времени, когда вы соображаете не на все сто. Посмотрите один из первых роликов в серии. (И обратите внимание на "great googly moogly" — это пример отличного копирайта, который до сих пор живет в популярной культуре.)
`youtube: D0IfvjoOqro`

Следующим шагом появилась формулировка "ты не ты" и прием с превращением.
`youtube: Zfg7XT_8Rto`

Эта гениальная платформа, потому что она позволяет решить большое количество задач. Например, вы можете вставить в ролик селебрити.
`youtube: iGsuZAUOMcA`

Или на основе этой платформы вы можете сделать большую диджитальную активацию с ценовым промо.
`youtube: bulCWD5yc2Q`

При желании вы всегда можете откатиться обратно, и перестать использовать показывать превращения. Так _тоже будет работать_!
`youtube: 3OKj_jZmonM`
...
И если бренд говорит, что его платформа — это открытость, а в федеральной кампании люди в восторге кричат от ставок по ипотеке, то 1) зачем ему эта открытость и, самое главное, 2) как люди о должны о ней узнать? Бренд не знает, я не знаю, и люди тоже не знают. Фреймворки — это классно и здорово. До тех пор, пока они решают ваши задачи.
