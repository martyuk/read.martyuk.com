...
### Сникерс
Когда речь заходит о бренд-платформах, то мне, как человеку, который работал в BBDO, сложно сдержаться и не рассказать про Сникерс. Потому что у него одна из самых гениальных платформ, которую _вы_ ее точно знаете! Конечно же, я говорю про "ты не ты, когда голоден".

Но "ты не ты" появилась не сразу. Она формулировалась постепенно, шаг за шагом. Все началось с задачи бренда рассказать про большое количество орехов. Из этого родилась территория голода, как момента времени, когда вы соображаете не на все сто. Посмотрите один из первых роликов в серии. (И обратите внимание на "great googly moogly" — это пример отличного копирайта, который до сих пор живет в популярной культуре.)
`youtube: D0IfvjoOqro`

Следующим шагом появилась формулировка "ты не ты" и прием с превращением.
`youtube: Zfg7XT_8Rto`

Еще одна причина, по которой я называю эту платформу гениальной — это универсальность. "Ты не ты" позволяет решить большое количество задач. Например, вы можете вставить в ролик селебрити.
`youtube: iGsuZAUOMcA`

Или сделать большую диджитальную активацию с ценовым промо.
`youtube: bulCWD5yc2Q`

При желании даже можно откатиться обратно, и перестать показывать превращения. Так _тоже будет работать_!
`youtube: 3OKj_jZmonM`
