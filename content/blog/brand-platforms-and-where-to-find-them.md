...
### Сникерс
Мне, как человеку, который работал в BBDO, сложно перебороть себя и не рассказать про Сникерс. А у Сникерса одна из самых гениальных платформ. И _вы_ ее точно знаете! Я говорю про "ты не ты, когда голоден".

Но "ты не ты" появилась не сразу, а формулировалась постепенно. Все началось с задачи рассказать про большое количество орехов. Из этого родилась территория голода, как момента времени, когда вы соображаете не на все сто. Посмотрите один из первых роликов на эту тему. (И обратите внимание на "great googly moogly" — это пример отличного копирайта, который до сих пор живет в популярной культуре.)
`youtube: D0IfvjoOqro`
...
При желании вы всегда можете откатиться обратно, и перестать показывать превращения. Так _тоже будет работать_!
`youtube: 3OKj_jZmonM`
