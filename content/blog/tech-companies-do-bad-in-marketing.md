...
При этом как правило, новые технологии меняют привычки людей и их представления о мире. Uber изменил не только то, как должен выглядеть сервис такси, но и то, какой скорости люди ожидают от сервисов в принципе [^14]. То есть технологии становятся катализатором изменений в культуре и обществе, а картина будущего, которую рисовала компания, — историей про происходящие изменения.
