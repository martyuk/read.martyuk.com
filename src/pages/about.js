...
export default props => (
  ...
  <p>
    ...
    Мое резюме можно посмотреть на <a href="https://linedin.com/martyuk">LinkedIn</a>, а портфолио — на <strike><a href="#">красивом лендинге</a></strike> (<i>скоро</i>) с анимацией и версткой.
  </p>
  <h3>Опыт</h3>
  <ul>
    <li>BBDO
      <ul>
        <li>Помогаю любимым клиентам достигать бизнес-показателей
          ...
          Отвечаю за креативный продукт от идеи
