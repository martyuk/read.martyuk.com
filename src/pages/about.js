...
export default props => (
  ...
  <li>Профи
      <ul>
        <li>Создаю креативный отдел внутри маркетинга. Пока без подробностей (<i>ну и ладно</i>).</li>
      </ul>
    </li>
  <li>Авиасейлс
      <ul>
        <li>Запускал новые продукты и разрабатывал единую платформу бренда, чтобы объединить новые продукты со <i>старыми</i>.</li>
